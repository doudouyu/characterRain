package com.example.administrator.characterrain;
...
private static  final  Integer[] COLORS = {Color.BLACK,Color.BLUE,Color.RED,Color.YELLOW,Color.GREEN,Color.DKGRAY,Color.CYAN};
